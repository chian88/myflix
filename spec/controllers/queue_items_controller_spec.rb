...
describe QueueItemsController do
	describe 'GET index' do
		it 'sets @queue_items to the queue item of the logged in user' do
	...
	describe 'POST create' do
		...
		it 'puts the video as the last one in the queue' do
			...
			south_park_queue_item = QueueItem.find_by(video_id: south_park, user_id: alice.id)
	...
	describe 'DELETE destroy' do
		...
		it 'normalizes the remaining queue item' do
			alice = Fabricate(:user)
			set_current_user(alice)
	...
	describe 'POST update_queue' do
		...
		context 'with queue item that do not belong to current user' do
